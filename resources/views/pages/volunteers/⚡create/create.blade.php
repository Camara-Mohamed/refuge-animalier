<div class="flex flex-col gap-4">
    ...
    <h2 class="font-serif font-bold text-2xl text-blue-strong">Créer un profil</h2>
    ...
    <form wire:submit="save" class="flex flex-col gap-6 max-w-xl p-6 md:p-8 bg-white rounded-lg shadow-[0px_5px_20px_0px_rgba(0,0,0,0.10)] border border-red-strong/20">
        ...
        <x-forms.fieldset title="Mot de passe">
            <x-forms.input for="password" type="password" wire:model="password" :required="true" placeholder="••••••••">Mot de passe</x-forms.input>
        </x-forms.fieldset>
